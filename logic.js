...
if (localStorage.getItem('hidePopup') == 'false') {
    createModal(
        'MCQ Mate is Here!!!',
        [
            'MCQ Mate is an updated version for the Cambridge MCQ Checker with more features and cleaner layout',
            `<span style="display: flex; align-items: center; gap: 0.5rem;">Do not show this popup again? <input type="checkbox" id="hide-popup-check" onclick="localStorage.setItem('hidePopup', 'true')"></span>`,
        ],
        [
            'Open MCQ Mate',
            () => {
                window.open('http://zieddev.github.io/mcq-mate/', "_self")
            },
        ], [
        'Close',
        () => {
